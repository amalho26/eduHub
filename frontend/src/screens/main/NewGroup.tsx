...
const NewGroupScreen = (props: NewGroupScreenProps) => {
  ...
  useLayoutEffect(() => {
    props.navigation.setOptions({
      ...
      headerRight: () => (
        ...
        >
          <Text style={[styles.cancelButtonText, { color: "#fff" }]}>Create Group</Text>
        </TouchableOpacity>
      ),
    });
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          onPress={onPressCreateGroup}
          disabled={!groupName || selectedUsers.length === 0 || !description}
        >
